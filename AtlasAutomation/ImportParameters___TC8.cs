...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ImportParameters___TC8 recording.
    /// </summary>
    [TestModule("a64cc6cb-99c8-4862-945a-03db726e768b", ModuleType.Recording, 1)]
    public partial class ImportParameters___TC8 : ITestModule
    {
        /// <summary>
        ...
        static ImportParameters___TC8 instance = new ImportParameters___TC8();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ImportParameters___TC8()
        {
            paramSearch8 = "TC_08_Adapt_Peak_OPT_Adapt_Def_Param";
        }

        /// <summary>
        /// Gets a static instance of this recording.
        /// </summary>
        public static ImportParameters___TC8 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        string _paramSearch8;

        /// <summary>
        /// Gets or sets the value of variable paramSearch8.
        /// </summary>
        [TestVariable("46223b9d-a31c-497f-a210-f57befccbe32")]
        public string paramSearch8
        {
            get { return _paramSearch8; }
            set { _paramSearch8 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$paramSearch8' with focus on 'Open.SearchEditBox'.", repo.Open.SearchEditBoxInfo, new RecordItemIndex(6));
            repo.Open.SearchEditBox.PressKeys(paramSearch8);
            Delay.Milliseconds(0);
