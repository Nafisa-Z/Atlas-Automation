...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ImportSchedule recording.
    /// </summary>
    [TestModule("16ae0c26-7e6e-4237-b917-44cd424ce098", ModuleType.Recording, 1)]
    public partial class ImportSchedule : ITestModule
    {
        /// <summary>
        ...
        /// </summary>
        public static ImportSchedule Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable schSearch.
        /// </summary>
        [TestVariable("c8fbc78c-5ca6-46da-adf0-1a745691b3d1")]
        public string schSearch
        {
            get { return _schSearch; }
            set { _schSearch = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$schSearch' with focus on 'Open'.", repo.Open.SelfInfo, new RecordItemIndex(9));
            repo.Open.Self.EnsureVisible();
            Keyboard.Press(schSearch);
            Delay.Milliseconds(0);
