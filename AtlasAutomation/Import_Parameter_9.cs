...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Import_Parameter_9 recording.
    /// </summary>
    [TestModule("b3fc918d-196d-44f0-9380-c731b5ed895c", ModuleType.Recording, 1)]
    public partial class Import_Parameter_9 : ITestModule
    {
        /// <summary>
        ...
        static Import_Parameter_9 instance = new Import_Parameter_9();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Import_Parameter_9()
        {
            Param_Search9 = "TC_09_Adapt_Low_OPT_Adapt_Def_Param";
        }

        /// <summary>
        /// Gets a static instance of this recording.
        /// </summary>
        public static Import_Parameter_9 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        string _Param_Search9;

        /// <summary>
        /// Gets or sets the value of variable Param_Search9.
        /// </summary>
        [TestVariable("124718f5-189d-4fe1-baef-b7707c94b9d3")]
        public string Param_Search9
        {
            get { return _Param_Search9; }
            set { _Param_Search9 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Param_Search9' with focus on 'Open.SearchEditBox'.", repo.Open.SearchEditBoxInfo, new RecordItemIndex(6));
            repo.Open.SearchEditBox.PressKeys(Param_Search9);
            Delay.Milliseconds(0);
