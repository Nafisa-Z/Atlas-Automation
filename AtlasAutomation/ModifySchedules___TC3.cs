...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ModifySchedules___TC3 recording.
    /// </summary>
    [TestModule("57c348b0-fe58-4612-bbd2-68079dd65115", ModuleType.Recording, 1)]
    public partial class ModifySchedules___TC3 : ITestModule
    {
        /// <summary>
        ...
        static ModifySchedules___TC3 instance = new ModifySchedules___TC3();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ModifySchedules___TC3()
        {
        ...
        /// </summary>
        public static ModifySchedules___TC3 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$datesLow' with focus on 'JobWindow.TC_03.OA_Dates'.", repo.JobWindow.TC_03.OA_DatesInfo, new RecordItemIndex(4));
            repo.JobWindow.TC_03.OA_Dates.PressKeys(datesLow);
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$datesLow' with focus on 'JobWindow.TC_03.Replacement_Dates'.", repo.JobWindow.TC_03.Replacement_DatesInfo, new RecordItemIndex(6));
            repo.JobWindow.TC_03.Replacement_Dates.PressKeys(datesLow);
            Delay.Milliseconds(0);
